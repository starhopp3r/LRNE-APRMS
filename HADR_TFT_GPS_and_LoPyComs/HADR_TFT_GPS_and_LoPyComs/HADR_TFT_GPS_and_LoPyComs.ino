...
// 'medical' (but ration because icon swap), 70x70px
...
// 'ration' (but shelter because icon swap), 70x70px
...
// 'shelter' (but medical because icon swap), 70x70px
