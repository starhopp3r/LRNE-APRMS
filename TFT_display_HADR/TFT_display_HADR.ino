...
String selectLeft(void);
String selectMid(void);
String selectRight(void);
//==============================================================================================
...
/*String selectLeft() {
  tft.drawRoundRect(1, tft.height() / 2 - 51, 103, 103, 10, WHITE);
  tft.fillRoundRect(1, tft.height() / 2 - 51, 103, 103, 10, WHITE);
  tft.drawRoundRect(100 + 8, tft.height() / 2 - 51, 103, 103, 10, BLACK);
  tft.fillRoundRect(100 + 8, tft.height() / 2 - 51, 103, 103, 10, BLACK);
  tft.drawRoundRect(200 + 13, tft.height() / 2 - 51, 103, 103, 10, BLACK);
  tft.fillRoundRect(200 + 13, tft.height() / 2 - 51, 103, 103, 10, BLACK);
  normalDisplay();
  return("Shelter");
  }

  String selectMid() {
  tft.drawBitmap(1, tft.height() / 2 - 51, 103, 103, 10, BLACK);
  tft.fillRoundRect(1, tft.height() / 2 - 51, 103, 103, 10, BLACK);
  tft.drawRoundRect(100 + 8, tft.height() / 2 - 51, 103, 103, 10, WHITE);
  tft.fillRoundRect(100 + 8, tft.height() / 2 - 51, 103, 103, 10, WHITE);
  tft.drawRoundRect(200 + 13, tft.height() / 2 - 51, 103, 103, 10, BLACK);
  tft.fillRoundRect(200 + 13, tft.height() / 2 - 51, 103, 103, 10, BLACK);
  normalDisplay();
  return("Food");
  ...
  String selectRight() {
  tft.drawRoundRect(1, tft.height() / 2 - 51, 103, 103, 10, BLACK);
  tft.fillRoundRect(1, tft.height() / 2 - 51, 103, 103, 10, BLACK);
  tft.drawRoundRect(100 + 8, tft.height() / 2 - 51, 103, 103, 10, BLACK);
  tft.fillRoundRect(100 + 8, tft.height() / 2 - 51, 103, 103, 10, BLACK);
  tft.drawRoundRect(200 + 13, tft.height() / 2 - 51, 103, 103, 10, WHITE);
  tft.fillRoundRect(200 + 13, tft.height() / 2 - 51, 103, 103, 10, WHITE);
  normalDisplay();
  return("Medical");
  }*/
